...
<center>
    ...
    <table width=700 border="0" cellpadding="2" cellspacing="0" id="sheet0" class="sheet0 gridlines">
        ...
        <thead>
          <tr>
        		<th class="fundo" style="border-top: 1px solid #000000; border-bottom: 1px solid #000000; border-left: 1px solid #000000; " colspan=4 height="35" align="center" valign=bottom><font size=5 color="#000000"><center>RELATÓRIO DE RECIBOS DETALHADO</center></font></th>
          ...
          <tr align="center" class="row4">
            ...
            <td style ="font-size:14px;"class="column1 style1 s"><b>Fornecedor</b></td>
            <td style ="font-size:14px;"class="column2 style1 s"><b>Controle</b></td>
            <td style ="font-size:14px;"class="column3 style1 s"><b>Nº nota</b></td>
            <td style ="font-size:14px; width: 150px;"class="column4 style1 s"><b>Valor</b></td>
