...
<div class="panel panel-default">
    <div style="font-size: 14pt" class="panel-heading">
        ...
        <form style="margin-left: 15px; float: right;" method="POST" class="form form-inline" action="php/edita_fds.php">
            <select required name="fds" class="form-control">
              <option disabled selected>Acesso no FDS?</option>
              <option value="1">Sim</option>
              <option value="0">Não</option>
            </select>
            <button style="margin-top: -10px;" class="btn btn-warning">Salvar</button>
        </form>
